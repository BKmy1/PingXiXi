...
public class SupermarketFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        list.add("http://39.108.61.227/picture/1-2.png");
        list.add("http://39.108.61.227/picture/1-3.png");
        list.add("http://39.108.61.227/picture/1-4.png");
        list.add("http://39.108.61.227/picture/1-5.png");
        list.add("http://39.108.61.227/picture/1-6.png");
        list.add("http://39.108.61.227/picture/1-7.png");
        list.add("http://39.108.61.227/picture/1-8.png");
        list.add("http://39.108.61.227/picture/1-9.png");
        list.add("http://39.108.61.227/picture/1-10.png");

        Banner banner = (Banner)view.findViewById(R.id.super_banner);
        //设置图片加载器
        ...
        recyclerView = view.findViewById(R.id.super_recy);
