...
public class PhoneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        list.add("http://39.108.61.227/picture/2.png");
        list.add("http://39.108.61.227/picture/3.png");
        list.add("http://39.108.61.227/picture/4.png");
        list.add("http://39.108.61.227/picture/5.png");
        list.add("http://39.108.61.227/picture/6.png");
        list.add("http://39.108.61.227/picture/7.png");
        list.add("http://39.108.61.227/picture/8.png");
        list.add("http://39.108.61.227/picture/9.png");
        list.add("http://39.108.61.227/picture/10.png");

        Banner banner = (Banner)view.findViewById(R.id.phone_banner);
        //设置图片加载器
        ...
        recyclerView = view.findViewById(R.id.phone_recy);
