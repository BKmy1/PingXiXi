package com.example.pingxixi.ui.supermarket;
...
public class SuperMarketCopyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_spuer_market_copy, container, false);
        ...
        Banner banner = (Banner)view.findViewById(R.id.super_copy_banner);
        //设置图片加载器
        ...
        recyclerView = view.findViewById(R.id.super_copy_recy);
    ...
    public void getData() {
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                Log.i("SuperMarketCopyFragment", result);
